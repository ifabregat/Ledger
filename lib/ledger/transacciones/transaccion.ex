defmodule Ledger.Transacciones.Transaccion do
  ...
  def transferencia_changeset(transaccion, attrs) do
    transaccion
    |> cast(attrs, [:monto, :tipo, :cuenta_origen_id, :moneda_origen_id, :cuenta_destino_id, :moneda_destino_id])
    |> validate_required([:monto, :tipo, :cuenta_origen_id, :moneda_origen_id, :cuenta_destino_id, :moneda_destino_id])
    |> validate_number(:monto, greater_than: 0, message: "El monto debe ser mayor que 0")
